namespace L11_AsteroidsAdvanced { // Keiner darf von außen das Objekt verändern (bei Puristen)
    // Man kann nur eine Methode aufrufen mit der man dann etwas prüft
