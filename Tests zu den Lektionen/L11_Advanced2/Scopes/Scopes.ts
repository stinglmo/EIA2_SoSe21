namespace Scope {
    ...
    sub.log();
    sup.log(); // Objekt - kleingeschrieben

    console.group("Scope");
    log("Scope", x);
    log("ScopeSuperStatic", ScopeSuper.x); // Eigenschaft/Methode der ganzen Klasse - großgeschrieben
    log("ScopeSubStatic", ScopeSub.x); // Zeile 16
    console.groupEnd();
