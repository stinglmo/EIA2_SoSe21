...
(function (L09_Asteroids) {
    class Asteroid {
        ...
        draw() {
            ...
            L09_Asteroids.crc2.scale(this.size, this.size); // in die Horizontale und Verticale
            L09_Asteroids.crc2.translate(-50, -50); // Koordinatenverschiebung, damit er von außerhalb kommt
