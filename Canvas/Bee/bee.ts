...
namespace Canvas {
    ...
    function handleLoad(_event: Event): void {
        ...
        for (var height: number = 450; height < 630; height += 2) {
            ...
            var randomFlower: number = Math.floor((Math.random() * 4));
    ...
    // Funktion Vogel
    function drawBird(_x: number, _y: number, _strokeColor: string, _fillColor: string): void {
    ...
    function drawCloud2(_x: number, _y: number): void {
        crc2.beginPath();
    ...
    function drawBird2(_x: number, _y: number): void {
    ...
    function drawTree2(_x: number, _y: number ): void {
