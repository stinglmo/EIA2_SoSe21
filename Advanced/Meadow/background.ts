...
namespace Advanced {
    ...
    export class Background {
        ...
        //Baum
        private static drawTree(_x: number, _y: number): void {
        ...
        //Vogel
        private static drawBird(_x: number, _y: number, _strokeColor: string, _fillColor: string): void {
        ...
        //Großer Busch
        private static drawBushBig(_x: number, _y: number, _fillColor: string): void {
        ...
        //Kleiner Busch
        private static drawBushSmall(_x: number, _y: number, _fillColor: string): void {
        ...
        private static drawBird2(_x: number, _y: number): void {
        ...
        //Bank zeichnen
        private static drawBank(_x: number, _y: number, _strokeColor: string, _fillColor: string, _strokeColor1: string, _fillColor1: string): void {
        ...
        private static drawTree2(_x: number, _y: number): void {
